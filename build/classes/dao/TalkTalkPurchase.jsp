...
<body>
<div class="fl ygstyle26 talktalk_dis2" style="background-color: rgba(240,242,245,.95);">
					<div class="ygstyle4">
						<div class="fl">
					...
					<div class="ygstyle25">
						...
						<div class="message_balloon card_message rgt">
							<p class="ygfont13 ygfont14">읽음</p>
							<span class="ygfont13 ">오후 <span>3:42</span></span>
							<p class="hi speechbubble">ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ</p>
						</div>
						...
						<div class="message_balloon card_message rgt">
							<p class="ygfont13 ygfont14">읽음</p>
							<span class="ygfont13 ">오후 <span>3:42</span></span>
							<p class="hi speechbubble">상품을 문의 주셨습니다. 어떤 점이 궁금하신가요?</p>
						</div>
