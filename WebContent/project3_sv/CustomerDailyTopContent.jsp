...
<head>
	...
	<link rel="stylesheet" href="../css/CustomerDailyTopContent.css" />
	...
	<div id="container" class="conmargin">
		...
		<div class="conmargin">
			<div class="contage">
					...
					<form action="CustomerDailyOrderTop.jsp" method="post">
...
<!-- 						<div class="deailptable">
							<table class="ptable">
								...
								<tbody>
									<tr>
										<th scope="row" class="ptableth">색상</th>
										<td colspan="1" class="ptabletd">퍼플, 블루</td>
										<th scope="row" class="ptableth">재질</th>
										<td colspan="1" class="ptabletd">NBR</td>
								</tbody>
							</table>	
						</div> -->
							...
							<div class="pinfo_demo">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3" class="ptabletd">색상 : 퍼플, 블루</td>
									</tr>
									<tr>
				...
				<div class="qna_con">
					...
					<div class="qna_content">
						<div class="qna_contentin">
							...
							<div class="qna_ct2">
								<span class="qna_ct2in">제목</span>
							</div>
							<div class="qna_ct3">
								<span class="qna_ct3in">제목</span>
							</div>
							<div class="qna_ct4">
