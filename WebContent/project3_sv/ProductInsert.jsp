	...
	window.onload = function() {
		...
		var instance = new Grid({
			...
			header : {
				complexColumns: [{
					...
					header : '옵션명',
					name : 'optionname',
					childNames: ['option1', 'option2','option3']
		          }
		        ],
		        height : 80
		      },
		...
		data : [ 
			...
			for(OptionDto dto : listOptionDto) {
				%>
			{
			option1 : '<%= dto.getValue()%>',
			option2 : '<%= dto.getValue2()%>',
			option3 : '<%= dto.getValue3()%>',
			optionprice : '<input type="text" style="text-align:center; border:none;" value="<%=dto.getPrice()%>"/>',
		...
		<div class="fl right_side">
				...
				<div class="seller-sub-content">
					<div class="seller-alert errorbar preparing">
						<p class="sub-title">
							<img src="../Images/warnning.png"/>
						임시저장 된 내용(</p>
						<em class="text-danger text-number">0</em>
						<p class="sub-title">건)을 불러오시겠습니까?</p>
						<img src="../Images/rightarrow.png" class="fr"style="position:relative;top:7px;left:40px;"/>
					</div>
							...
							<div class="con_line">
								<div class="fl">
									<label class="control_label">할인
										<img src="../Images/subtitleafter.png"/>
									</label>
								</div>
								<div class="fl"style="height:34px">
					...
					<div class="panel">
						...
						<div id="blind-content7" class="content-content" style="display:none;">
							...
							<div id="optionsuljung" style="display:none; position: relative; top:5px;padding-bottom: 10px;">
								 	...
								 	<div class="sub_line">
										<div class="fl">
											<label class="control_label" style="position:relative; left:35px;">옵션 구성타입
												<i class="musticon" style="left:2px; position: relative;"></i>
												<img src="../Images/subtitleaftergrey.png"/>
											</label>
										</div>
										<div class="fl l60">
											<div class="fl mr35">
								...
								<div class="sub_con_line">
								 	<div class="sub_sub_line">
										...
										<div style="width: 335px; margin-left: 217px;">
											<a role="button" href="OptionAction.jsp" id="optionlistbtn" class="option_btn mt10">
												옵션목록으로 적용
											</a>
										</div>
								</div>
								...
								<div>
									<div class="fl">
										<button class="buttype" style="width:67px; position:relative; left:35px; top:3px;">
											<span class="fs12">선택삭제</span>
										</button>
									</div>
									<div class="fr" style="position:relative; right:35px;">
										<div class="fl">옵션가
											<img src="../Images/subtitleaftergrey.png" style="position: relative;top: 5px;"/>
										</div>
										<div class="fl mr7 input-group">
												<button class="option_plusbt">+
							...
							<div class="first_line">
								<div class="fl">
									<label class="control_label">대표이미지
										<i class="musticon" style="left:2px; position: relative;"></i>
										<img src="../Images/support.png" style="top:6px; left:4px; position:relative;"/>
									</label>
								</div>
								<div class="fl">
