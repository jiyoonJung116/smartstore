...
<head>
<meta charset="UTF-8">
<title>공통관리/상단형</title>
<link rel="stylesheet" href="../css/smartstoresidebar.css"/>
<link rel="stylesheet" href="../css/MiddleCustomerDailyTop.css" />
...
<script>
	$(function() {
		...
		//상단형/좌측형 바꾸기
		$("#left_layout").click(function() {
			location.href="CommonManageTotalLeft.jsp";
		});
...
<body>
<form action="CommonupdateActionTop.jsp" method="post">
	<div id="header">
