...
<%@page import="dao.*"%>
	...
	ArrayList<AnnouncementDto> andto = andao.select(seller_id);
...
<head>
	<meta charset="UTF-8">
	<title>DailyLeftANCM</title>
	<link rel="stylesheet" href="../css/DailyLeftANCM.css" />
...
<div class="pdcontent">
			<div>
				<div class="pd_title">
					<strong class="pd_titles">공지사항</strong>
					<div class="fr">
						<div class="myanswer">
							<a href="#" class="answerstate" role="button" aria-expanded="false" aria-haspopup="listbox">전체</a>
						</div>
						<div style="clear:both;"></div>
					</div>
				</div>
				<div class="pd_menu">
					<table class="pd_menutable">
						...
						<thead>
							<tr class="pd_menutr">
								<th class="pd_menuth">구분</th>
								<th class="pd_menuth">제목</th>
								<th class="pd_menuth">작성일</th>
								<th class="pd_menuth">상품번호</th>
							</tr>
						</thead>
						<tbody>
						<% for(AnnouncementDto adto: andto){ %>
							<tr class="pd_menutr">
								<td class="pd_menutd">상품</td>
								<td class="pd_menutd" style="float:left;"><a href="DailyLeftAM_content.jsp?serialNum=<%=adto.getSerialNum()%>"><%=adto.getSubject() %></a></td>
								<td class="pd_menutd"><%=adto.getRegDate() %></td>
								<td class="pd_menutd"><%=adto.getPnumber() %></td>
							</tr>
							<% } %>
							<!-- <tr class="pd_menutr">
								<td class="pd_menutd">일반</td>
								<td class="pd_menutd" style="float:left;"><a href="DailyLeftAM_content.jsp">자동수거 불가 공지</a></td>
								<td class="pd_menutd">2020.04.18.</td>
								<td class="pd_menutd">0</td>
							</tr> -->
						</tbody>
					</table>
				</div>
