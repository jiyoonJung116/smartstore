<%@page import="dto.FreeProductDto2"%>
<%@page import="java.util.ArrayList"%>
<%@page import="dao.FreeProductSearch2Dao"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
    request.setCharacterEncoding("utf-8");
    
    FreeProductSearch2Dao listFree = new FreeProductSearch2Dao();
    
    String loginId = "jiyoonjung";
    ArrayList<FreeProductDto2> freelist = listFree.getFreeProductList(loginId);
    %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>자유상품관리/좌측형</title>
<link rel="stylesheet" href="../css/FreeProductM.css" />
...
<script>
	...
	$(document).ready(function() {
		$(".freest31:contains('3')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('4')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('5')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('6')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('7')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('8')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('9')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('10')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('11')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
		});
		$(".freest31:contains('12')").on("click", function() {
			let selectedValue = $(this).text();
			$(".freest29").text(selectedValue);
			$(".freest31").removeAttr("aria-selected");
			$(this).attr("aria-selected", "true");
	...
	$(function() {
		$(".prepare").click(function() {
		 ...
		 $(document).ready(function() {
			    $(".display6_delete").click(function() {
			      let checkedRows = $(".display32").closest("tbody").find(":checked"); 

			      let displayOrder = checkedRows.map(function() {
			        let row = $(this).closest("tr"); 
			        return row.find(".display32").val(); 
			      }).get();
			      let encodedDisplayOrder = encodeURIComponent(displayOrder);
			      if ($(".display29 .display29_1:checked").length > 0) {
						location.href = "FreeProductDeleteAction.jsp?displayOrder="+encodedDisplayOrder;
						$(".free_table").css('display', 'block');
					} else {
						alert("상품을 선택해주세요.");
					}
			    });
		...
		$(".freest28").click(function() {
			if ($(".freest30").css('display') === 'none') {
				$(".freest30").css('display', 'block');
			} else {
				$(".freest30").css('display', 'none');
			}
		});

		$("#check_all").click(function() {
			if ($(this).prop('checked')) {
				$('#check_4897832395').prop('checked', true);
			} else {
				$('#check_4897832395').prop('checked', false);
			}
		});
		...
		$(".input_style1").keyup(function(e) {
							...
							$(".charcount").html(
											'<div class="fl charcount"><span class="freefont1">'
													+ content.length
													+ '</span><span class="freefont2">15</span></div>');
		...
		$(".component_list_box").click(
				function() {
					...
					$(".component_list_box[aria-check=true]").attr(
							$(".component_txtbtn").attr("aria-checked", "false"));
				});

	});

	function open1() {
		window.open('FindProduct.jsp', '_blank');
	}
</script>
...
<body>
						...
						<div class="gnb_position">
							...
							<div class="position_btn">
								<div class="radio_position">
									<div class="radio_box">
										<input type="radio" id="top_radio" class="cilck_position blind" name="checkedType" value="top" />
	...
	<div class="freest fl freest37" style="height: 900px; width: 830px;">
		<div class="freest1 ">
			<div class="freest2">
				<strong class="freefont">자유상품 관리</strong>
			</div>
			<div class="freest3">
				<div class="custom_product_list_form">
					<div class="title">
						...
						<div class="input_style">
							<input name="title" type="text" class="input_style1 fl" placeholder="제목을 입력해주세요." maxlength="15" value="자유상품">
							<div class="fl charcount">
								<span class="freefont1">4</span>
								<span class="freefont2">15</span>
							</div>
						</div>
					</div>
					<div class="freest6"></div>
					<div class="custom_project1">
						<div class="freest7">
							<strong class="freefont3">디자인 유형</strong>
						</div>
						<ul class=freest8>
							<li class="freest9_1">
								<div class="freest10" data-value="LIST">
									<input id="customProductWidget-display-size-type-LIST" class="_1EF5iAWwDG blind" type="radio" name="productDisplayType" value="LIST"> 
									<label class="freest11" for="customProductWidget-display-size-type-LIST"> 
										<span class="freest12"></span> 
										<span class="freest13">리스트형</span> 
										<span class="freest14"></span>
									</label>
								</div>
							</li>
							<li class="freest9">
								<div class="freest10" data-value="FULL_IMAGE">
									<input id="customProductWidget-display-size-type-FULL_IMAGE" class="_1EF5iAWwDG blind" type="radio" name="productDisplayType" value="FULL_IMAGE">
									<label class="freest11" for=customProductWidget-display-size-type-FULL_IMAGE>
										<span class="freest12"></span>
										<span class="freest13">풀이미지형</span>
										<span class="freest14"></span>
									</label>
								</div>
							</li>
					...
					<div class="custom_product_list_area">
						...
						<div class="custom_project2">
							...
							<ul class="freest8">
								<li class="freest18"><div class="freest19 custom1" data-value="SQUARE">
										<input id="customProductWidget-thumbnail-type-SQUARE" class="O1gTqVQj7O blind" type="radio" name="thumbnailShapeType" value="SQUARE" checked>
										<label class="freest20" for="customProductWidget-thumbnail-type-SQUARE">
											<span class="freest21"></span>
											<span class="freest22">정사각형</span>
											<span class="freest23"></span>
										</label>
									</div>
								</li>
								<li class="freest18 freest24"><div class="freest19 custom2" data-value="V_RECT">
										<input id="customProductWidget-thumbnail-type-V_RECT" class="O1gTqVQj7O blind" type="radio" name="thumbnailShapeType" value="V_RECT">
										<label class="freest20" for="customProductWidget-thumbnail-type-V_RECT">
											<span class="freest21"></span>
											<span class="freest22">세로직사각형</span>
											<span class="freest23"></span>
										</label>
									</div>
								</li>
								<li class="freest18 freest24"><div class="freest19 custom3" data-value="H_RECT">
										<input id="customProductWidget-thumbnail-type-H_RECT" class="O1gTqVQj7O blind" type="radio" name="thumbnailShapeType" value="H_RECT">
										<label class="freest20" for="customProductWidget-thumbnail-type-H_RECT">
											<span class="freest21"></span>
											<span class="freest22">가로직사각형</span>
											<span class="freest23"></span>
										</label>
									</div>
								</li>
						...
						<div class="custom_project3">
							...
							<div class="freest28">
								<div class="freest4">
									<a href="#" class="freest29">8</a>
									<ul id="display-count-form-select-box-customProductWidget" class="freest30">
										<li role="presentation">
											<a href="#" class="freest31">3</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">4</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">5</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">6</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">7</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">8</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">9</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">10</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">11</a>
										</li>
										<li role="presentation">
											<a href="#" class="freest31">12</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="product_button" style="margin-top: 13px;">
							<p class="detail_style " style="margin-bottom: 3px;">Drag&amp;Drop으로 전시순서와 원하는 상품을 자유롭게 전시할 수 있습니다.</p>
							<div class="display1">
								<div class="display1" style="margin-top: 22px;">
									<strong class="display2 display3">총 상품 수
										<span class="display4"> 1</span>개
									</strong>
								</div>
								<div class="display5">
									<button class="display6" type="button" onclick="open1()">상품 추가</button>
									<button class="display6 display6_delete" type="button">삭제</button>
								</div>
							</div>
							<div class="display7">
								<div class="display8">
									<button type="button" class="display9 display9_1">
										<span class="blind">맨 아래로</span>
									</button>
									<button type="button" class="display9 display9_2 display10">
										<span class="blind">한칸 아래로</span>
									</button>
									<button type="button" class="display9 display9_3 display10">
										<span class="blind">한칸 위로</span>
									</button>
									<button type="button" class="display9 display9_4 display10">
										<span class="blind">맨 위로</span>
									</button>
								</div>
								<ul class="freest32 prepare">
									<li class="freest33">
										<div class="freest4">
											<input id="customProductWidget-product-table-filter-type-ONGOING" class="_1KZycvyi6X blind" type="checkbox"
												name="productDisplayFilterType" value="ONGOING" checked>
												<label class="freest34" for="customProductWidget-product-table-filter-type-ONGOING">
													<span class="freest35"></span>
													<span class="freest36">전시중(1개)</span>
												</label>
										</div>
									</li>
									<li class="freest33"><div class="freest4">
											<input id="customProductWidget-product-table-filter-type-DISPLAYABLE" class="_1KZycvyi6X blind" type="checkbox"
												name="productDisplayFilterType" disabled value="DISPLAYABLE">
												<label class="freest34" for="customProductWidget-product-table-filter-type-DISPLAYABLE">
													<span class="freest35"></span>
													<span class="freest36">전시가능(0개)</span>
												</label>
										</div></li>
									<li class="freest33"><div class="freest4">
											<input id="customProductWidget-product-table-filter-type-NOT_DISPLAYABLE" class="_1KZycvyi6X blind" type="checkbox"
												name="productDisplayFilterType" disabled value="NOT_DISPLAYABLE">
												<label class="freest34" for="customProductWidget-product-table-filter-type-NOT_DISPLAYABLE">
													<span class="freest35"></span><span class="freest36">전시불가(0개)</span>
												</label>
										</div>
									</li>
								</ul>
							...
							<div class="display17">
								<table class="display16">
									...
									<thead class="display18">
										<tr>
											<th class="display19" scope="col">
												<div class="display20">
													<input type="checkbox" id="check_all" class="display21_1 blind" checked> 
														<label for="check_all" class="display21">
											...
											<th class="display19" scope="col">
												<div class="display23">상품번호 / 상품명 / 카테고리</div>
											</th>
											<th class="display19" scope="col">
												<div class="display24">주문수</div>
											</th>
											<th class="display19" scope="col">
												<div class="display24">유입수</div>
											</th>
											<th class="display19" scope="col">
												<div class="display24">찜수</div>
											</th>
											<th class="display19" scope="col">
												<div class="display25">판매가</div>
											</th>
											<th class="display19" scope="col">
												<div class="display26">전시상태</div>
											</th>
										</tr>
									</thead>
									<tbody class="free_table" style="display: none;">
										<tr class="free_table1">
											<td>상품이 없습니다.</td>
										</tr>
									</tbody>
									<!--  -->
									<%for(int i =0; i<=freelist.size()-1; i++){
												FreeProductDto2 dto = freelist.get(i);
											%>
									<tbody class="display27">
										<tr class="_3Xmg5ZrngK" draggable="true" style="opacity: 1;">
											<td class="display28">
												<div class="display29">
													<input type="checkbox" id="check_<%=dto.getDisplayorder()%>" class="display29_1 blind">
													<label for="check_<%=dto.getDisplayorder()%>" class="display30">
														<span class="blind">상품 선택</span>
														<span id="hiddenValue" style="display:none;"> <%=dto.getDisplayorder()%></span>
													</label>
												</div>
											</td>
											<td class="display28">
												<div class="display31">
													<input type="text" class="display32" value=<%=dto.getDisplayorder() %>>
												</div>
											</td>
											<td class="display28">
												<div class="display33">
													<div class="display34" style="background-image: url(<%=dto.getImage()%>);"></div>
													<div class="display35">
														<a class="display36" target="_blank"
															href="https://smartstore.naver.com/customerfordaily/products/4897832395">[<%=dto.getPnumber()%>]
															<%=dto.getPname() %></a>
														<span class="display37"><%=dto.getLarge()%>&gt;<%=dto.getMiddle() %>&gt;<%=dto.getSub() %></span>
													</div>
													<a class="display38" target="_blank" href="https://sell.smartstore.naver.com/#/products/edit/4882283804">수정</a>
												</div>
											</td>
											<td class="display28">
												<div class="display40 display39">
													<%=dto.getOrdercount() %>
												</div>
											</td>
											<td class="display28">
												<div class="display40 display39"><%=dto.getHitcount() %></div>
											</td>
											<td class="display28">
												<div class="display40 display39"><%=dto.getLike() %></div>
											</td>
											<td class="display28">
												<div class="display41"><%=dto.getPrice() %></div>
											</td>
											<td class="display28">
												<div class="display42"><%=dto.getDisplayStatus() %></div>
											</td>
										</tr>
									</tbody>
									<%} %>
						...
						<div class="subjectbar">
							...
							<div class="topmenu">
								<div class="menucontent">
									<ul class="ulstype">
										<li><a class="listtype">스포츠/레저 </a></li>
										<li><a class="listtype">가구/인테리어 </a></li>
										<li><a class="listtype">전체상품 </a></li>
									</ul>
									<ul class="ulstype2">
						...
						<div class="right">
							...
							<div class="pcontent">
								<div class="newpcontent">
									...
									<ul class="newpul">
										<li class="newpli"><a class="newpimg"> <span
												class="newpimgbox"> <img class="newpimgdetail"
													src="https://shop-phinf.pstatic.net/20230418_111/1681799580486YXXTK_JPEG/31283187665536431_1220162550.jpg?type=f400_324">
											</span> <span class="newpnamebox"> <strong class="newp1name">폼폼푸린
														손목쿠션</strong>
										...
										<li class="newpli"><a class="newpimg"> <span
											...
											</span> <span class="newpnamebox"> <strong class="newp1name">가구
														수평패드</strong>
										...
										<li class="newpli"><a class="newpimg"> <span
											...
											</span> <span class="newpnamebox"> <strong class="newp1name">요가매트</strong>
										...
										<ul class="allpul">
											<li class="allpli"><a class="allpimg"> <span
													class="allpimgbox"> <img class="allpimgdetail"
														src="https://shop-phinf.pstatic.net/20230418_111/1681799580486YXXTK_JPEG/31283187665536431_1220162550.jpg?type=f400_324">
															...
															손목쿠션</strong>
												</span> <span class="allpricebox"> <strong
														class="allp1price">400,000원 </strong>
												</span>
											</a>
											...
											<li class="allpli"><a class="allpimg"> <span
													class="allpimgbox"> <img class="allpimgdetail"
														...
														class="allp1price">25,000원 </strong>
												</span>
											</a>
											...
											<li class="allpli"><a class="allpimg"> <span
													class="allpimgbox"> <img class="allpimgdetail"
														...
														class="allp1price">29,900원 </strong>
												</span>
											</a>
												<button type="button" class="likey"></button></li>
										</ul>
											...
											<div class="fl ft2_div1">
												...
												<div class="ft2_div1in">
													...
													1784, 13561<br> 전화 1588-3819 <span
														...
														target="_blank" class="ft2_div1ina">사업자등록정보 확인</a><br />
											...
											<div class="fl ft2_div2">
												...
												<div class="ft2_div2in">
													강원도 춘천시 퇴계로 89 강원전문건설회관<br /> 전화 1588-3819 <a href="#"
														class="ft2_div2ina" target="_blank">전화전클릭</a><br />
													결제도용신고 1588-3816<br /> <a
