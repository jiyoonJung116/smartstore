...
<head>
	<meta charset="UTF-8">
	<title>DailyTopANCM</title>
	<link rel="stylesheet" href="../css/DailyTopANCM.css" />
					...
					<table class="pd_menutable">
						...
						<tbody>
							...
							<tr class="pd_menutr">
								...
								<td class="pd_menutd" style="float:left;"><a href="DailyTopAM_content.jsp?serialNum=<%=adto.getSerialNum()%>"><%=adto.getSubject() %></a></td>
							...
							<!-- <tr class="pd_menutr">
								...
								<td class="pd_menutd" style="float:left;"><a href="DailyTopAM_content.jsp">자동수거 불가 공지</a></td>
