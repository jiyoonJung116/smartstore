...
<script>
	$(function() {
		...
		/* $("#storepc").load("CustomerDailyLeft.jsp"); */
		let new_name = $("#ssname").val();
		$("#ssname").val(new_name);
		$("#storeNameTab").click(function() {
			$(".maNaGe").css("display","none");
			$("#storeNameManage").css("display","block");
		});
		$("#allProductTab").click(function() {
			$(".maNaGe").css("display","none");
			$("#allProductManage").css("display","block");
		});
...
<body>
<form action="StoreNameAction.jsp">
	<div id="header">
			...
			<div class="left_height">
					<div class="left_padding"> 
						...
						<div class="component_margin">
							<div>
								<div class="component_txtbtn" id="storeNameTab" role="button" aria-checked="true">
									<div class=component_txt>스토어 이름</div>
								</div>
								<div class="component_txtbtn" id="categoryTab" role="button" aria-checked="false">
								...
								<div class="component_list_box" id="allProductTab" role="button" aria-checked="false">
		...
		<!-- 스토어이름관리 -->
	<div class="hole_style fl maNaGe" id="storeNameManage" style="height: 900px; width: 830px; display:none;">
		...
		<div class="stnamebox">
			...
			<div class="inputbox">
				<input name="new_name" type="text" id="ssname" class="inputstorename" placeholder="<%=storedto.getStore_name()%>" value="">
			</div>
	...
	<!-- 전체상품 -->
	<div class="freest fl freest37 maNaGe" id="allProductManage" style="height: 900px; width: 830px;">
		<div class="freest1 ">
			<div class="freest2">
				...
				<div class="storename">
					<div class="center">
						<h1 class="storemiddle">
							<a href="https://smartstore.naver.com/customerfordaily">
