<%@page import="dto.PromotionImageDto"%>
...
/* function applyImage() {
	  ...
	  let piimgst4Button = document.querySelector(".piimgst4");
	  ...
	  reader.onload = function(e) {
	    ...
	    imageContainer.appendChild(img); // 새로운 이미지 추가
	    piimgst4Button.style.backgroundImage = `url('${e.target.result}')`; // 버튼에 이미지 배경 설정
	  };
	...
	/* document.addEventListener('DOMContentLoaded', function() {
	  ...
	  fileInput.addEventListener("change", function() {
	    ...
	    reader.onload = function(e) {
	      ...
	      let popup7 = document.querySelector(".popup7");
	      popup7.style.display = "none"; // 이미지 등록 안내 문구 숨김
	    }
	...
	$(function() {
		...
		/* $(".pist6").click(function(){
		/* alert("_this.attr( src ) : " + $(this).parent().find('.piimgst24').css('display','block')); */
		/*if($(this).parent().find('.piimgst24').css('display')==='none'){
		$(this).parent().find('.piimgst24').css('display','block');
		} else if($(this).parent().find('.piimgst24').css('display')==='block'){
			$(this).parent().find('.piimgst24').css('display','none');	
		}
		}); */
		...
		$(document).on("click", ".pist11", function() {
			$(this).parents(".piimgst_only").remove();
		});
...
<body>
								...
								<div class="radio_position">
									<div class="radio_box">
										<input type="radio" id="top_radio"
											...
											checked="checked" /> <label for="top_radio" class="for_top">
											<span class="top_icon"></span> <span class="radio_txt">상단형</span>
	...
	<div class="fl" style="position: relative; overflow: hidden; width: 832px; height: 896px;">
		<div style="position: absolute; inset: 0px; overflow: scroll; margin-right: -17px; margin-bottom: -17px;">
			...
			<div class="pist3">
				<div>
							...
							<div class="pist5">
								<div class="piimgst_only">
									<div class="pist6">
										...
										<div class="pist12">
											<div class="pist13">
												<input id="2" class="blind" type="checkbox" checked>
												<label class="piimg" for="2"></label>
											</div>
										</div>
										<a class="pist14" role="button">
											<span class="blind">상품 클릭</span>
										</a>
									</div>
									<!--  -->
					...
					<button class="pisbt" type="submit" style="margin-top: 24px;">이미지
						추가</button>
				</div>
			</div>
		</div>
					...
					<div class="fr">
						<div class="right">
							<div class="promotion">
								...
								<script>alert('pimg_select size : <%=pimg_select.size()%>');</script>
								<%for(PromotionImageDto dto : pimg_select){%>
									<li class="promotionimg" style="background-image: url(../Images/<%=dto.getImageF()%>)!important">
										<div class="promotiontext">
											<div class="promotiontext1">
												<div class="promotiontext2">
													<strong class="pmtext"><%=dto.getSubject() %></strong>
												</div>
											</div>
										</div>
									</li>
