...
<head>
<meta charset="UTF-8">
<title>공통관리/좌측형</title>
<link rel="stylesheet" href="../css/smartstoresidebar.css"/>
<link rel="stylesheet" href="../css/MiddleCustomerDailyLeft.css" />
<script src="../js/jquery-3.7.0.min.js"></script>
<script>
	$(function() {
		let seller_id = $("#param_id").text();
		$("#input_seller_id").val(seller_id);
		let color = $(".color[aria-checked=true]").css("background-color");
		...
		$(".color_hotpink").click(function() {
			let color = $(this).css("background-color");
			$(".topcolor").css("background-color",color);
			$("#input_color").val(color);
		});
		$(".color_orangered").click(function() {
			let color = $(this).css("background-color");
			$(".topcolor").css("background-color",color);
			$("#input_color").val(color);
		});
		...
		if($(".color_black").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_black").attr("aria-checked","true");
		}else if($(".color_gray").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_gray").attr("aria-checked","true");
		}else if($(".color_blue").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_blue").attr("aria-checked","true");
		}else if($(".color_brown").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_brown").attr("aria-checked","true");
		}else if($(".color_green").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_green").attr("aria-checked","true");
		}else if($(".color_cyan").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_cyan").attr("aria-checked","true");
		}else if($(".color_pink").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_pink").attr("aria-checked","true");
		}else if($(".color_hotpink").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_hotpink").attr("aria-checked","true");
		}else if($(".color_orangered").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_orangered").attr("aria-checked","true");
		}else if($(".color_red").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_red").attr("aria-checked","true");
		}else if($(".color_violet").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_violet").attr("aria-checked","true");
		}else if($(".color_yellow").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_yellow").attr("aria-checked","true");
		}else if($(".color_orange").css("background-color")==$(".topcolor").css("background-color"))  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_orange").attr("aria-checked","true");
		}else  {
			$(".color[aria-checked=true]").attr("aria-checked","false");
			$(".color_ivory").attr("aria-checked","true");
		}
		$("#top_layout").click(function() {
...
<body>
	<form action="CommonupdateAction.jsp" method="post">
	<div id="header">
							...
							<div class="common_margin">
								<div>
									...
									<div class="color_btn">
										...
										<input type="hidden" name="color" id="input_color" value="<%=color%>"/>
									</div>
								</div>
								<div class="gnb_position">
									...
									<div class="position_btn">
										<div class="radio_position">
											<div class="radio_box" id="top_layout">
												<input type="radio" id="top_radio" class="cilck_position blind" name="location" value="상단형"/>
										...
										<div class="radio_position">
											<div class="radio_box" id="left_layout">
												<input type="radio" id="left_radio" class="cilck_position blind" name="location" value="좌측형" checked="checked" />
...
<div class="fl theme_display" style="width:1630px;">
	<div class="smallss">
		<div class="pc">
