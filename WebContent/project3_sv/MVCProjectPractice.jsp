...
// 	    }
	    ArrayList<취소관리Dto> listRet = (ArrayList<취소관리Dto>)request.getAttribute("listRet");
...
<script>
	...
	$(function() {
		...
		$("#cancel_complete").click(function(){
			...
			location.href = "../PController?cancel=취소완료"; 
		});
		$("#cancel_request").click(function(){
			let dc = $("#cancel_request_1").text();
			location.href = "../PController?cancel=취소요청";
		});
...
//alert("date2 : " + date2);
			...
			location.href = "../PController?menu=" + encodedMenu + "&date=" + encodedDate +
