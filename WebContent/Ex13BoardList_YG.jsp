	...
	<script>
		$(function() {
			$("#btn_write").click(function() {
				location.href = "Ex13BoardWrite_YG.jsp";
			});
			$("tr").click(function() {
				let bno = $(this).find(".bno").text();
				location.href = "Ex13BoardDetail_YG.jsp?bno=" + bno;
			});
		});
	</script>
	<style>
...
<body>
	...
	<div style="padding-left:100px;">
		...
		<a href="Ex13BoardList.jsp?page=8">8</a>
		<a href="Ex13BoardList.jsp?page=9">9</a>
		<a href="Ex13BoardList.jsp?page=10">10</a>
	</div>
	<div>
