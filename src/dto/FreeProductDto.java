...
public class FreeProductDto {
	...
	public FreeProductDto(String image, String pname, int price) {
		this.image = image;
		this.pname = pname;
		this.price = price;
	}
	public FreeProductDto(long pnumber, String image, String pname, String salesStatus, String displayStatus, int price,
